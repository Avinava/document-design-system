---
description: Write a decidable proposal as Markdown in the user's repository. Use when invoked as /document-design-system:proposal. Produce designed HTML or PDF only when asked.
---

Use the `writing-documents` skill.
Type slug: proposal
Load `references/type-proposal.md`, `references/writing.md`, `references/evidence.md`.
